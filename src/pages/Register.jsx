      ...
      >
        ...
        >
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <User className="h-5 w-5 text-dark-400 dark:text-cream-400" />
                </div>
                <input
                  id="name"
                  name="name"
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="terms" className="ml-2 block text-sm text-dark-600 dark:text-cream-300">
              I agree to the{' '}
              <a href="#" className="text-dark-900 dark:text-cream-400 hover:text-dark-700 dark:hover:text-cream-300">
                Terms of Service
              </a>{' '}
              and{' '}
              <a href="#" className="text-dark-900 dark:text-cream-400 hover:text-dark-700 dark:hover:text-cream-300">
